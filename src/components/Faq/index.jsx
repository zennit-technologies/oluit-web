            ...
            <div className="flex-1">
              <div className="bg-white sm:p-10 p-5">
                ...
                <div className="inputs mt-5">
                    ...
                    <textarea
                      ...
                      placeholder="Type your message here"
                        className={` w-full h-[105px] focus:ring-0 focus:outline-none p-3 border placeholder:text-sm ${
                            !!(errors && Object.hasOwn(errors, "message")) ? "border-qred" : "border-qgray-border"
                        }`}
                    ></textarea>
                  ...
                  <div>
                    <button disabled={name && email && subject && message ?false:true}  onClick={sendHandler} type="button" className="disabled:bg-gray-400 disabled:cursor-not-allowed bg-qblack text-white text-sm font-semibold w-full h-[50px] flex justify-center items-center">
