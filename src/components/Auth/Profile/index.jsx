            ...
            <div className="title-area w-full flex justify-between items-center">
              ...
              {checkSellerAndVendor && (
                <div className="switch-dashboard flex space-x-3 items-center">
                  <p className="text-qgray text-base">{ServeLangItem()?.Switch_Dashboard}</p>
                  <button
                ...
                <div className="flex xl:flex-col flex-row xl:space-y-10 flex-wrap gap-3 xl:gap-0">
                  <div className="item group">
                    <Link href="/profile#dashboard">
                      <div className="flex space-x-3 items-center text-qgray hover:text-qblack capitalize">
                        <span>
                          <IcoDashboard />
                        </span>
                  ...
                  <div className="item group">
                    <Link href="/profile#order">
                      <div className="flex space-x-3 items-center text-qgray hover:text-qblack capitalize">
                        ...
                        <span className=" font-normal text-base capitalize cursor-pointer">{ServeLangItem()?.Order}</span>
                      </div>
                    </Link>
                  </div>
                  <div className="item group">
                    <Link href="/profile#wishlist">
                      <div className="flex space-x-3 items-center text-qgray hover:text-qblack capitalize">
                        ...
                        <span className=" font-normal text-base capitalize cursor-pointer">{ServeLangItem()?.Wishlist}</span>
                      </div>
                    </Link>
                  </div>
                  <div className="item group">
                    <Link href="/profile#address">
                      <div className="flex space-x-3 items-center text-qgray hover:text-qblack capitalize">
                        ...
                        <span className=" font-normal text-base capitalize cursor-pointer">{ServeLangItem()?.Address}</span>
                      </div>
                    </Link>
                  </div>
                  <div className="item group">
                    <Link href="/profile#review">
                      <div className="flex space-x-3 items-center text-qgray hover:text-qblack capitalize">
                        ...
                        <span className=" font-normal text-base capitalize cursor-pointer">{ServeLangItem()?.Reviews}</span>
                      </div>
                    </Link>
                  </div>
                  <div className="item group">
                  ...
                  <div className="item group">
                    <div
                      onClick={logout}
                      className="flex space-x-3 items-center text-qgray hover:text-qblack capitalize"
                    >
                      <span>
                        <IcoLogout />
                      </span>
                      <span className=" font-normal text-base capitalize cursor-pointer">{ServeLangItem()?.Logout}</span>
                    </div>
                  </div>
                </div>
              </div>
