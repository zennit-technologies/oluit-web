      ...
      <Layout>
        ...
        {homepage && (
          <Banner
            ...
            className="banner-wrapper md:mb-[20px] mb-[10px]"
          />
        )}
        {homepage && (
          <CategorySection
        ...
        {homepage && (
          <SectionStyleOne
            ...
            className="category-products md:mb-[10px] mb-[5px]"
          />
        )}
        {homepage && (
          <BrandSection
            ...
            className="brand-section-wrapper md:mb-[10px] mb-[5px]"
          />
        )}

        {homepage && (
          <CampaignCountDown
            className="md:mb-[20px] mb-[10px]"
        ...
        {homepage && (
          <ViewMoreTitle
            className="top-selling-product md:mb-[20px] mb-[10px]"
        ...
        {homepage && isMultivendor === 1 && (
          <ViewMoreTitle
            className="best-sallers-section md:mb-[20px] mb-[10px]"
            seeMoreUrl="/sellers"
        ...
        {homepage && (
          <SectionStyleThree
            ...
            seeMoreUrl="/all-products"
            className="new-products md:mb-[20px] mb-[10px]"
          />
        )}

        {homepage && (
          <div className="w-full text-white md:mb-[20px] mb-[10px]">
