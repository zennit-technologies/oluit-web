                ...
                <div className="sm:flex justify-between items-center mb-4">
                  ...
                  <div>
                    <button
                      onClick={print}
                      type="button"
                      className="w-[161px] h-[52px] rounded flex space-x-2.5 items-center justify-center bg-qyellow print:hidden mt-5 sm:mt-0"
                    >
                      <span>
                        <svg
                          width="27"
                ...
                <div className="flex sm:justify-end print:justify-end justify-center sm:mr-10">
                  <div>
                    <div className="flex justify-between font-semibold w-[200px] mb-1">
                      <p className="text-sm text-qblack capitalize">{ServeLangItem()?.SUBTOTAL}</p>
                      <p className="text-sm text-qblack">
                        <span>{currency_icon}</span>
                        <span>{(parseFloat(resData.total_amount) +
                                parseFloat(resData.shipping_cost)) +
                            parseFloat(resData.coupon_coast)}</span>
                      </p>
                    </div>
                    ...
                    <div className="flex justify-between font-semibold w-[200px]">
                      <p className="text-sm text-qblack">(+) {ServeLangItem()?.Shipping_Cost}</p>
                      <p className="text-sm text-qblack">
                        +<span>{currency_icon}</span>
                    ...
                    <div className="flex justify-between font-semibold w-[200px] mt-4">
                      <p className="text-lg text-qblack">{ServeLangItem()?.Total_Paid}</p>
