  ...
  return (
    <>
      <div className="write-review w-full mb-[30px]">
        <h1 className="text-2xl font-bold text-qblack mb-5">{ServeLangItem()?.leave_a_comment}</h1>
          ...
          <div className="flex justify-end">
            ...
            >
              <span className="flex space-x-1 items-center h-full">
                <span className="text-sm font-semibold">{ServeLangItem()?.Submit_Review}</span>
                {reviewLoading && (
      ...
      {commnets.length > 0 && (
        <div className="w-full comments">
          ...
          <h1 className="text-2xl font-medium text-qblack my-5">{ServeLangItem()?.Comments}</h1>
          {commnets &&
            commnets.length > 0 &&
